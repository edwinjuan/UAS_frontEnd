            ...
            <v-form class="mt-10 mb-4">
                <v-container>
                    <v-row>
                        ...
                        <v-col cols="6" sm="1">
                            <v-btn color="blue" class="mt-2 d-flex align-center" rounded darken @click="profile"><v-icon>mdi-account-tie</v-icon></v-btn>
                        </v-col>
                    </v-row>
                </v-container>
            </v-form>
      ...
      >
        ...
        >
          ...
          >
            ...
            <v-list-item-content>
              <v-list-item-title>{{ follower.title }}</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
        </v-list>
      </v-navigation-drawer>
